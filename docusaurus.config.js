...
const config = {
  ...
  organizationName: 'go-architect', // Usually your GitHub org/user name.
  projectName: 'go-architect.github.io', // Usually your repo name.
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Go-Architect, Inc. Built with Docusaurus.`,
      },
      prism: {
